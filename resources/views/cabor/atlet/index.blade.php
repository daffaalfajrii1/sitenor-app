...
@include('admin.components.page-header', [
    ...
    'actions' => view('admin.components.excel-toolbar', [
        'module' => 'atlet',
        'createRoute' => cabor_route('cabor.atlet.create'),
        'createLabel' => 'Tambah Atlet',
        'templateUrl' => cabor_route('cabor.excel.template', ['module' => 'atlet']),
        'importUrl' => cabor_route('cabor.excel.import', ['module' => 'atlet']),
    ])->render(),
])
                    ...
                    @forelse ($atlets as $atlet)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ cabor_route('cabor.prestasi.atlet', ['atlet' => $atlet]) }}" class="sitenor-count-badge bg-soft-primary text-primary text-decoration-none" title="Lihat prestasi">
                            ...
                            <td class="text-end">
                                <x-admin.components.table-actions>
                                    <a href="{{ cabor_route('cabor.prestasi.atlet', ['atlet' => $atlet]) }}" class="btn btn-sm btn-light-brand">Prestasi</a>
                                    <a href="{{ cabor_route('cabor.prestasi.create', ['atlet_id' => $atlet->id]) }}" class="btn btn-sm btn-primary">+ Prestasi</a>
                                    <a href="{{ cabor_route('cabor.atlet.edit', $atlet) }}" class="btn btn-sm btn-light-brand">Edit</a>
                                    <form action="{{ cabor_route('cabor.atlet.destroy', $atlet) }}" method="POST" class="d-inline m-0" onsubmit="return confirm('Hapus atlet ini?')">
                                        @csrf @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center text-muted py-5">
                                ...
                                <a href="{{ cabor_route('cabor.atlet.create') }}" class="d-block mt-2 fw-semibold">Tambah atlet pertama</a>
                            </td>
                        </tr>
                    @endforelse
                    </tbody>
