...
<header class="nxl-header">
    <div class="header-wrapper">
        <div class="header-left d-flex align-items-center gap-4">
            ...
            <span class="badge bg-soft-success text-success d-none d-md-inline">Kepala Cabor</span>
            @if($user->cabor)
                <span class="badge bg-soft-primary text-primary d-none d-md-inline">{{ $user->cabor->name }}</span>
            @endif
        </div>
        ...
        <div class="header-right ms-auto sitenor-header-profile">
            <div class="sitenor-profile-wrap">
                ...
                <div class="sitenor-profile-menu shadow">
                    ...
                    <a href="{{ cabor_route('cabor.profile.edit') }}" class="sitenor-profile-menu-item">
