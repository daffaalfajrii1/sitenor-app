...
@include('admin.components.page-header', [
    ...
    'actions' => '<a href="'.cabor_route('cabor.prestasi.create', ['atlet_id' => $atlet->id]).'" class="btn btn-primary"><i class="feather-plus me-2"></i>Tambah Prestasi</a>',
])
...
<div class="main-content sitenor-prestasi-atlet-page">
    ...
    @if($atlet->prestasis->isEmpty())
        <div class="card sitenor-table-card border-0">
            <div class="card-body text-center py-5 px-4">
                ...
                <a href="{{ cabor_route('cabor.prestasi.create', ['atlet_id' => $atlet->id]) }}" class="btn btn-primary btn-lg">
                    ...
                    <div class="card sitenor-prestasi-card h-100 border-0">
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap gap-2 mt-3 pt-3 border-top">
                                <a href="{{ cabor_route('cabor.prestasi.edit', $p) }}" class="btn btn-sm btn-light-brand flex-grow-1">Edit</a>
                                <form action="{{ cabor_route('cabor.prestasi.destroy', $p) }}" method="POST" class="flex-grow-1" onsubmit="return confirm('Hapus prestasi ini?')">
                                    @csrf @method('DELETE')
    ...
    <div class="mt-4">
        <a href="{{ cabor_route('cabor.prestasi.index') }}" class="btn btn-light-brand">
