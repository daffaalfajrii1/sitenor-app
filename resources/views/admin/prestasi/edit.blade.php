...
@include('admin.components.page-header', [
    ...
    'crumbs' => [
        ...
        ['label' => $prestasi->atlet->name, 'url' => route('admin.prestasi.atlet', $prestasi->atlet_id)],
        ['label' => 'Edit'],
    ],
])
        ...
        <div class="card-body">
            <form action="{{ route('admin.prestasi.update', $prestasi) }}" method="POST">
                ...
                <div class="d-flex flex-wrap gap-2 mt-4">
                    ...
                    <a href="{{ route('admin.prestasi.atlet', $prestasi->atlet_id) }}" class="btn btn-light">Batal</a>
                </div>
            </form>
        </div>
    </div>
